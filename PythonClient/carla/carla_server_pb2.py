...
_MEASUREMENTS_PLAYERMEASUREMENTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='angular_velocity', full_name='carla_server.Measurements.PlayerMeasurements.angular_velocity', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='linear_velocity', full_name='carla_server.Measurements.PlayerMeasurements.linear_velocity', index=11,
...
_MEASUREMENTS_PLAYERMEASUREMENTS.fields_by_name['angular_velocity'].message_type = _VECTOR3D
_MEASUREMENTS_PLAYERMEASUREMENTS.fields_by_name['linear_velocity'].message_type = _VECTOR3D
